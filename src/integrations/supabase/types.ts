    ...
    Tables: {
      ...
      aml_rules: {
        Row: {
          ...
          typology_keywords: string[] | null
          updated_at: string
          user_id: string
          velocity_count: number | null
          velocity_window_hours: number | null
        }
        Insert: {
          amount_operator?: string | null
          amount_threshold?: number | null
        ...
        Relationships: [
          {
            ...
            columns: ["dossier_id"]
            isOneToOne: false
            referencedRelation: "investigation_dossiers"
      ...
      dossier_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "dossier_transactions_dossier_id_fkey"
            columns: ["dossier_id"]
            isOneToOne: false
            referencedRelation: "investigation_dossiers"
            referencedColumns: ["id"]
